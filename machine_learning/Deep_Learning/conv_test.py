"""
This code was taken from Chapter 6 of the book 'Neural Networks and Deep Learning', by Michael Nielsen, and was originally written by him.  I have taken the code, and modified it to try out some of the deep learning techniques first hand. 
"""
